...
from diffusion.cascade_diffusion_not2t import GaussianDiffusion, Trainer
...
def main(args):
    ...
    if args.eval:
        ...
        if trainer.diffusion.diffusion_model.cascade:
    ...
    if args.cascade_gen:
        ...
        if args.class_conditional:
            ...
            trainer.sample_cascade(cls_free_guidance=2.0, test=True)
        return
...
if __name__ == "__main__":
    ...
    if args.eval or args.resume_training or args.cascade_gen:
        ...
        heldout_params = {'wandb_name', 'wandb_project', 'output_dir', 'resume_dir', 'eval', 'cascade_gen', 'num_samples', 'num_train_steps', 'sampling_timesteps', 'sampling_schedule', 'scale', 'sampler', 'resume_training'}
