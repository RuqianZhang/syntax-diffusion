...
def process_amazon(dataset, cascade):
    def extract_amazon_text(example):
        ...
        if cascade:
            ...
            return {'text': sentence, 'context': main_structs}
...
def get_dataloader(args, dataset, model_config, text_tokenizer, syntax_tokenizer, max_seq_len, context_max_seq_len,
...
def get_class_dataloader(args, dataset, model_config, text_tokenizer, syntax_tokenizer, max_seq_len,  context_max_seq_len,
